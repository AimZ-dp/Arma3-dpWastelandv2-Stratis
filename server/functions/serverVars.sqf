...
objectList = [
			...
			"Land_CampingTable_F", 
			//"Land_CampingTable_folded_F", 
			//"Land_CampingTable_obj_F", 
			...
			//"Land_AnimalBones_cow_F", 
			//"Land_AnimalBones_sheep_F", 
			//"Land_BodyBag_F", 
			"Land_Grave_V1_F", 
			"Land_Grave_V2_F", 
			"Land_Grave_V3_F", 
			...
			//"Land_MilGrave_local_F", 
			//"Land_MilGrave_NATO_F",
			...
			//"Land_Shoot_House_Door_F", 
			//"Land_Shoot_House_Window_F", 
			...
			//"Land_Target_Static_F", 
			//"Land_Target_Static_Full_F", 
			//"Land_Target_PopUp_F", 
			//"Land_Target_Static_Man_F", 
			//"Land_Target_Spinning_F", 
			//"Land_Target_Spinning_Wall_F", 
			"Land_Target_Oval_F", 
			//"Land_Target_Oval_Wall_Left_F", 
			//"Land_Target_Oval_Wall_Right_F", 
			//"Land_Target_Oval_Wall_Top_F", 
			//"Land_Target_Oval_Wall_Bottom_F", 
			//"Land_Target_Hanging_F",
			...
			//"Land_Barricade_F", 
			//"Land_Barricade_concrete_F", 
			//"Land_Barricade_wrecks_F", 
			"Land_HBarrier_1_F", 
			"Land_HBarrier_3_F", 
			"Land_HBarrier_5_F", 
			"Land_HBarrierBig_F", 
