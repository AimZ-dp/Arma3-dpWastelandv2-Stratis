...
uniformArray = [	
	...
	["V_RebreatherB","Rebreather [NATO]", 100,"vest"],
...
baseObjectList = [
	...
	["Concrete Ramp","Land_RampConcrete_F",50,""],
	["Concrete Ramp (High)","Land_RampConcreteHigh_F",50,""],	
	["Obstacle (Bridge)","Land_Obstacle_Bridge_F",50,""],	

	["Bar Gate","Land_BarGate_F",50,""],
	["Crash Barrier","Land_Crash_barrier_F",50,""],
	["Razorwire Barrier","Land_Razorwire_F",50,""],	
	["Wired Fence 10m","Land_New_WiredFence_10m_F",50,""],	
	
	["Halogen Lamp","Land_LampHalogen_F",50,""],
	...
	["Bag Bunker (Large)","Land_BagBunker_Large_F",150,""],
	["Bag Bunker (Tower)","Land_BagBunker_Tower_F",150,""],
	
	["Concrete Barrier","Land_CncBarrier_F",100,""],
	["Concrete Barrier (Stripes)","Land_CncBarrier_stripes_F",100,""],
	["Concrete Barrier (Medium)","Land_CncBarrierMedium_F",100,""],
	["Concrete Barrier (Medium, Long)","Land_CncBarrierMedium4_F",100,""],
	["Concrete Shelter","Land_CncShelter_F",150,"client\ui\pictures\ConcreteShelter.paa"],
	
	["Concrete Wall","Land_CncWall1_F",100,""],
	["Concrete Wall (Long)","Land_CncWall4_F",100,""],
	["Concrete Wall (Small, 4m)","Land_Concrete_SmallWall_4m_F",100,""],
	["Concrete Wall (Small, 8m)","Land_Concrete_SmallWall_8m_F",100,""],
	
	["H-barrier (Block)","Land_HBarrier_1_F",100,""],
	["H-barrier (3 Blocks)","Land_HBarrier_3_F",100,""],
	["H-barrier (5 Blocks)","Land_HBarrier_5_F",100,""],
	["H-barrier (Big, 4 Blocks)","Land_HBarrierBig_F",100,""],
	["H-barrier Wall (Corner)","Land_HBarrierWall_corner_F",100,""],
	["H-barrier Wall (Short)","Land_HBarrierWall4_F",100,""],
	["H-barrier Wall (Long)","Land_HBarrierWall6_F",100,""],
	["H-barrier Corridor","Land_HBarrierWall_corridor_F",100,""],
	
	["H-barrier Watchtower","Land_HBarrierTower_F",150,""],
	...
	["Building - Garage","Land_i_Garage_V1_F",200,""],	
	["Diesel Powerplant Tank (Small)","Land_dp_smallTank_F",200,""],	
	["Diesel Powerplant Tank (Big)","Land_dp_bigTank_F",200,""],	
	["Reservoir Tower","Land_ReservoirTower_F",200,""]
];
