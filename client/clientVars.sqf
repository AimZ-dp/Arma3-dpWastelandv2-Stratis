...
ammoArray = [
	["9mm 16Rnd Mag","16Rnd_9x21_Mag",10,5],	
	["9mm 30Rnds Mag","30Rnd_9x21_Mag",30,15], 		
	[".45 ACP 9Rnd Mag","9Rnd_45ACP_Mag",15,7],	
	["5.56mm 20Rnd UW Mag","20Rnd_556x45_UW_mag",15,7],	
	["5.56mm 30Rnd STANAG Mag","30Rnd_556x45_Stanag",15,7],
	["5.56mm 30Rnd STANAG Mag (Red)","30Rnd_556x45_Stanag_Tracer_Red",15,7],
	["5.56mm 30Rnd STANAG Mag (Green)","30Rnd_556x45_Stanag_Tracer_Green",15,7],
	["5.56mm 30Rnd STANAG Mag (Yellow)","30Rnd_556x45_Stanag_Tracer_Yellow",15,7],	
    //["6.5mm 30Rnd C Mag","30Rnd_65x39_case_mag",25,12],
	//["6.5mm 30Rnd C Mag (Tracer)","30Rnd_65x39_case_mag_Tracer",25,12],
	["6.5mm 30Rnd CL Mag","30Rnd_65x39_caseless_mag",30,15],		
	["6.5mm 30Rnd CL Mag (Tracer)","30Rnd_65x39_caseless_mag_Tracer",30,15],
	["6.5mm 100Rnd CL Mag","100Rnd_65x39_caseless_mag",50,25],			
	["6.5mm 100Rnd CL Mag (Tracer)","100Rnd_65x39_caseless_mag_Tracer",50,25],
	["6.5mm 30Rnd CL Mag (Katiba)","30Rnd_65x39_caseless_green",30,15],	
	["6.5mm 30Rnd CL Mag (Katiba, Tracer)","30Rnd_65x39_caseless_green_mag_Tracer",30,15],
	["7.62mm 20Rnd Mag","20Rnd_762x51_Mag",40,20],			
	["6.5mm 200Rnd Belt","200Rnd_65x39_cased_Box",50,25],			
	["6.5mm 200Rnd Belt (Tracer)","200Rnd_65x39_cased_Box_Tracer",50,25],	
	["7.62mm 150Rnd Box","150Rnd_762x51_Box",50,25],				
	["7.62mm 150Rnd Box (Tracer)","150Rnd_762x51_Box_Tracer",50,25],			
	["12.7mm 5Rnd Mag (GM6)","5Rnd_127x108_Mag",100,50], 	
	[".408 7Rnds Mag (LRR)","7Rnd_408_Mag",100,50], 	
	
	[".45 ACP 30Rnds Mag","30Rnd_45ACP_Mag_SMG_01",30,15], 	
	[".45 ACP 30Rnds Mag (Tracer)","30Rnd_45ACP_Mag_SMG_01_tracer_green",30,15], 

	["NLAW Missile","NLAW_F",100,50],	
    ["RPG32 Missile","RPG32_F",100,50],	
    ["RPG32 AA Missile","RPG32_AA_F",100,50],	
    ["Titan AA Missile","Titan_AA",100,50],		
    ["Titan (Compact) AT Missile","Titan_AT",100,50],	
    ["Titan (Compact) AP Missile","Titan_AP",100,50],	
	
	["Mini Grenade", "MiniGrenade", 100,50],
	["Hand Grenade", "HandGrenade", 100,50],
    ["AT Mine","ATMine_Range_Mag",100,50],
    ["APERS Mine","APERSMine_Range_Mag",100,50],
    ["APERS Bounding Mine","APERSBoundingMine_Range_Mag",100,50],
    ["M6 SLAM Mine","SLAMDirectionalMine_Wire_Mag",100,50],
    ["APERS Tripwire Mine","APERSTripMine_Wire_Mag",100,50],
    ["Claymore Charge","ClaymoreDirectionalMine_Remote_Mag",100,50],
	["Explosive Charge","DemoCharge_Remote_Mag",100,50],
    ["Explosive Satchel","SatchelCharge_Remote_Mag",100,50],	
	
	["1Rnd GL Flare (White)","UGL_FlareWhite_F",45,10],
	["1Rnd GL Flare (Green)","UGL_FlareGreen_F",45,10],
	["1Rnd GL Flare (Red)","UGL_FlareRed_F",45,10],
	["1Rnd GL Flare (Yellow)","UGL_FlareYellow_F",45,10],
	["1Rnd GL Flare (CIR)","UGL_FlareCIR_F",45,10],
	["1Rnd HE Grenade Shell","1Rnd_HE_Grenade_shell",45,10],
	["1Rnd Smoke Grenade Shell","1Rnd_Smoke_Grenade_shell",45,10],
	["1Rnd Smoke Grenade Shell (Red)","1Rnd_SmokeRed_Grenade_shell",45,10],
	["1Rnd Smoke Grenade Shell (Green)","1Rnd_SmokeGreen_Grenade_shell",45,10],
	["1Rnd Smoke Grenade Shell (Yellow)","1Rnd_SmokeYellow_Grenade_shell",45,10],
	["1Rnd Smoke Grenade Shell (Purple)","1Rnd_SmokePurple_Grenade_shell",45,10],
	["1Rnd Smoke Grenade Shell (Blue)","1Rnd_SmokeBlue_Grenade_shell",45,10],
	["1Rnd Smoke Grenade Shell (Orange)","1Rnd_SmokeOrange_Grenade_shell",45,10],
	["3Rnd GL Flare (White)","3Rnd_UGL_FlareWhite_F",45,10],
	["3Rnd GL Flare (Green)","3Rnd_UGL_FlareGreen_F",45,10],
	["3Rnd GL Flare (Red)","3Rnd_UGL_FlareRed_F",45,10],
	["3Rnd GL Flare (Yellow)","3Rnd_UGL_FlareYellow_F",45,10],
	["3Rnd GL Flare (CIR)","3Rnd_UGL_FlareCIR_F",45,10],
	["3Rnd HE Grenade Shell","3Rnd_HE_Grenade_shell",45,10],
	["3Rnd Smoke Grenade Shell","3Rnd_Smoke_Grenade_shell",45,10],
	["3Rnd Smoke Grenade Shell (Red)","3Rnd_SmokeRed_Grenade_shell",45,10],
	["3Rnd Smoke Grenade Shell (Green)","3Rnd_SmokeGreen_Grenade_shell",45,10],
	["3Rnd Smoke Grenade Shell (Yellow)","3Rnd_SmokeYellow_Grenade_shell",45,10],
	["3Rnd Smoke Grenade Shell (Purple)","3Rnd_SmokePurple_Grenade_shell",45,10],
	["3Rnd Smoke Grenade Shell (Blue)","3Rnd_SmokeBlue_Grenade_shell",45,10],
	["3Rnd Smoke Grenade Shell (Orange)","3Rnd_SmokeOrange_Grenade_shell",45,10],

	["Chemlight (Blue)", "Chemlight_blue", 10,1],
	["Chemlight (Green)", "Chemlight_green", 10,1],
	["Chemlight (Red)", "Chemlight_red", 10,1],
	["Chemlight (Yellow)", "Chemlight_yellow", 10,1],
	
	["SmokeShell", "SmokeShell", 10,1],
	["SmokeShell (Red)", "SmokeShellRed", 10,1],
	["SmokeShell (Green)", "SmokeShellGreen", 10,1],
	["SmokeShell (Yellow)", "SmokeShellYellow", 10,1],
	["SmokeShell (Purple)", "SmokeShellPurple", 10,1],
	["SmokeShell (Blue)", "SmokeShellBlue", 10,1],
	["SmokeShell (Orange)", "SmokeShellOrange", 10,1]
...
generalStore = [
	...
	["Jerry Can (Full)","fuelFull",localize "STR_WL_ShopDescriptions_fuelFull","client\ui\icons\jerrycan.paa",150,75],
