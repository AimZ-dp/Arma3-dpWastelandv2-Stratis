...
class WastelandHud {
	...
	class controlsBackground {
		...
		class WastelandHud_Status:w_RscText
		{
			...
			lineSpacing = 3;
			colorBackground[] = {0,0,0,0};
			text = "100 <img size='0.8' image='client\ui\icons\food.paa'/><br/>100 <img size='0.8' image='client\ui\icons\water.paa'/><br/>200 <img size='0.8' image='client\ui\icons\money.paa'/>";
			shadow = 2;
			class Attributes {
				align = "right";
			};
